package com.rongshu.springcloudbefore;
...
public class SpringCloudBeforeApplication {

    public static void main(String[] args) {
        SpringApplication application = new SpringApplication(SpringCloudBeforeApplication.class);
